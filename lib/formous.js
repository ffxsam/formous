    ...
    return function (_Component) {
      ...
      function _class2(props) {
        ...
        _this.validateForm = function (fields) {
          var checkFields = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;

          var fieldsTouched = fields.reduce(function (touched, field) {
            return touched || field.get('dirty');
          }, false);
          var dirtyFields = fields.reduce(function (fields, field, fieldName) {
            return fields.set(fieldName, field.set('dirty', true));
          }, _this.state.fields);
          var validatedFields = checkFields ? dirtyFields.reduce(function (updated, field, name) {
        ...
        _this.handleSubmit = function (formHandler) {
          return function (event) {
            ...
            var _this$validateForm = _this.validateForm(_this.state.fields);
        ...
        _this.isFormValid = function (fields, options) {
          ...
          var formValid = Object.keys(stateFields).filter(function (fieldName) {
            ...
            return field.valid || !field.criticalFail;
          });
        ...
        _this.onValidatedChange = function (fieldSpec, _ref) {
          ...
          var validatedFields = _this.onChangeField(field, fieldSpec.name, fields);
        ...
        _this.updateFormFields = function (values) {
          ...
          var validatedFields = mapValues.reduce(function (updatedFields, value, fieldName) {
            return _this.onChangeField(updatedFields.get(fieldName), fieldName, updatedFields);
          }, fields);
        ...
        _this.onBlur = function (fieldSpec) {
          ...
          var validatedFields = _this.onChangeField(field, fieldSpec.name, updatedFields);
          _this.setState({
        ...
        _this.setDefaultValues = function (defaultData) {
          if (!_this.defaultsSet) {
            ...
            var validatedFields = updatedFields.reduce(function (fields, field, fieldName) {
              return _this.onChangeField(field, fieldName, fields);
            }, updatedFields);
            _this.updateFields(validatedFields);
        ...
        _this.onChangeField = function (field, fieldName, fields) {
          var checkAlsoTests = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
