    ...
    return function (_Component) {
      ...
      function _class2(props) {
        ...
        _this.onValidatedChange = function (fieldSpec, _ref) {
          ...
          var testResult = _this.checkField(_this.state.fields.get(fieldSpec.name), fieldSpec, _this.state.fields);
        ...
        _this.onBlur = function (fieldSpec, _ref2) {
          ...
          var updatedFields = _this.state.fields.set(fieldSpec.name, field.merge({
            value: target.value,
            dirty: true
          }));
